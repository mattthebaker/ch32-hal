//! Universal Serial Bus Device(USBD)
//!
//! This peripheral is almost the same as usb_v1 in embassy-stm32.
...
mod btable {
    ...
    // Format: [ADDR0_TX, COUNT0_TX, ADDR0_RX, COUNT0_RX]
...
foreach_interrupt!(
    ($inst:ident, usbd, $block:ident, LP, $irq:ident) => {
